...
namespace Robots_vs_Dinosaurs
{
    public class Herd
    {
        ...
        public void GetDinosaurs()
        {
            ...
            Console.WriteLine($"D1: {dinosaurs[1].dinoType} Health:{dinosaurs[1].dinoHealth} Energy:{dinosaurs[1].dinoHealth} Attack Power:{dinosaurs[1].dinoAttackPower}");
            Console.WriteLine($"D1: {dinosaurs[2].dinoType} Health:{dinosaurs[2].dinoHealth} Energy:{dinosaurs[2].dinoHealth} Attack Power:{dinosaurs[2].dinoAttackPower}");
